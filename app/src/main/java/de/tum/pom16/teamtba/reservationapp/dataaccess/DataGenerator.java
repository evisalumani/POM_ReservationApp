...
//        r1.setOpeningTimes(7, new HourTimeSlot(10, 0), new HourTimeSlot(24, 0));
        ...
        r6.setOpeningTimes(Calendar.TUESDAY, new HourTimeSlot(7, 0), new HourTimeSlot(15, 0));
        ...
        Table table2 = new Table(2, 4, 10, 24);
        Table table3 = new Table(3, 4, 10, 24);
        Table table4 = new Table(4, 4, 10, 24);
